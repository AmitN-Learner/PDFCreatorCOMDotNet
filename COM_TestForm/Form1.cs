    ...
    public partial class Form1 : Form
    {
        ...
        private pdfforge.PDFCreator.UI.ComWrapper.Queue CreateQueue()
        {
           ...
           return new pdfforge.PDFCreator.UI.ComWrapper.Queue();
            ...
            //{
            //    Type queueType = Type.GetTypeFromProgID("PDFCreator.JobQueue");
            //    que = Activator.CreateInstance(queueType);
            //    _isTypeInitialized = true;
            //    return que;
            //}
            //else
            //{
            //    return new pdfforge.PDFCreator.UI.COM.Queue();
            //}
        ...
        private void PrintWindowsTestPage()
        {
            ...
            //shellInst.ShellExecute("RUNDLL32.exe", "PRINTUI,PrintUIEntry /k /n \"Foxit Reader PDF Printer\"");
        }
